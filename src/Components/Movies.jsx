  ...
  return (
    <div className="w-full h-screen p-2">
      <div className="p-6 w-full flex items-center gap-2">
        ...
        <h1 className="text-zinc-400 font-bold text-3xl mb-[6px]">Movies</h1>
        <Topnav />
      </div>
      ...
      <div className="w-full flex justify-end gap-4 items-center mb-10">
        ...
        <div className="relative w-[15vw] mr-10">
          <select
            ...
            className="block w-full px-3 py-1 pr-8 text-base text-gray-900 bg-zinc-400 border border-gray-300 rounded-lg shadow-sm appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          >
